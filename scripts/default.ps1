...
$packableProjectDirectories = @("$srcRoot\App.Metrics", "$srcRoot\AspNet.Metrics", "$srcRoot\App.Metrics.Formatters.Json", "$srcRoot\App.Metrics.Extensions.Reporting.TextFile","$srcRoot\App.Metrics.Extensions.Reporting.Console")
