...
$packableProjectDirectories = @("$srcRoot\App.Metrics", "$srcRoot\App.Metrics.Concurrency", "$srcRoot\App.Metrics.Extensions.Middleware", "$srcRoot\App.Metrics.Formatters.Json", "$srcRoot\App.Metrics.Extensions.Reporting.TextFile","$srcRoot\App.Metrics.Extensions.Reporting.Console")
