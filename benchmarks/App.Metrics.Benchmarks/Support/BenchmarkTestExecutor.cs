...
namespace App.Metrics.Benchmarks.Support
{
    public class BenchmarkTestExecutor
    {
        ...
        protected BenchmarkTestExecutor(ITestOutputHelper output) { Output = output; }
        ...
        /// <param name="fullValidation">Optional: disable validation (default = true/enabled)</param>
        /// <returns>The summary from the benchmark run</returns>
        protected Summary CanExecute(Type type, IConfig config = null, bool fullValidation = true)
        {
            ...
            if (fullValidation)
            {
                ...
                Assert.True(
                    summary.Reports.All(r => r.ExecuteResults != null),
