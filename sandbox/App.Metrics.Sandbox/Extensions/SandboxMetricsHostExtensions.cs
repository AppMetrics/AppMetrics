...
using HttpPolicy = App.Metrics.Extensions.Reporting.ElasticSearch.HttpPolicy;
...
#pragma warning disable SA1111, SA1009, SA1008
    public static class SandboxMetricsHostExtensions
    {
        ...
        private static void AddInfluxReporting(IReportFactory factory, DefaultMetricsFilter reportFilter)
        {
            factory.AddInfluxDb(
                new InfluxDBReporterSettings
                {
                    HttpPolicy = new Metrics.Extensions.Reporting.InfluxDB.HttpPolicy
                                 {
                                     FailuresBeforeBackoff = 3,
                                     BackoffPeriod = TimeSpan.FromSeconds(30),
                                     Timeout = TimeSpan.FromSeconds(10)
