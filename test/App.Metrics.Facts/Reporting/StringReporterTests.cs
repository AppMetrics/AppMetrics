...
namespace App.Metrics.Facts.Reporting
{
    public class StringReporterTests
    {
        ...
        public void can_report_histograms()
        {
            ...
            var sr = new StringReporter();            
            var metric = new HistogramMetric(SamplingType.ExponentiallyDecaying, Constants.ReservoirSampling.DefaultSampleSize, Constants.ReservoirSampling.DefaultExponentialDecayFactor);
        ...
        public void can_report_timers()
        {
            ...
            var sr = new StringReporter();
            var clock = new TestClock();
            var histogram = new HistogramMetric(SamplingType.ExponentiallyDecaying, Constants.ReservoirSampling.DefaultSampleSize, Constants.ReservoirSampling.DefaultExponentialDecayFactor);
