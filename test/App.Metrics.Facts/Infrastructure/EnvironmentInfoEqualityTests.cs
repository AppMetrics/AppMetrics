...
namespace App.Metrics.Facts.Infrastructure
{
    public class EnvironmentInfoEqualityTests
    {
        ...
        {
            var env = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
            var env2 = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS2", "OS version2", "x64", "x64", "4");
        ...
        {
            var env = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
            var other = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
        ...
        {
            var env = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
            var other = new EnvironmentInfo("framework", "assembly2", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
        ...
        {
            var env = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
            var env2 = new EnvironmentInfo("framework", "assembly", "entry", "time", "machine", "OS", "OS version", "x64", "x64", "4");
