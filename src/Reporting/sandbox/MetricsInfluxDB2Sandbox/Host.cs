...
namespace MetricsInfluxDBSandbox
{
    ...
    {
        private const string InfluxDbOrganization = "myorg";
        private const string InfluxDbBucket = "appmetricssandbox";
        private const string InfluxDbToken = "TMdTbkvRRcI9BslBN9dhI04HNlPgfjSrhIV4LeHf0u9g6Zczhl5lYCrwtkKwukMsKGIpHLJAE4Xddkyk9OSfrA==";
