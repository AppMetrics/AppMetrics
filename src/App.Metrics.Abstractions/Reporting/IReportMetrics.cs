// <copyright file="IReportMetrics.cs" company="Allan Hardy">
...
namespace App.Metrics.Reporting
{
    public interface IReportMetrics
    {
        ...
        /// <summary>
        ///     Gets <see cref="TimeSpan"/> interval to flush metrics values. Defaults to <see cref="AppMetricsConstants.Reporting.DefaultFlushInterval"/>
        /// </summary>
