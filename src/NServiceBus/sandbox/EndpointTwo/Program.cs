...
namespace EndpointTwo
{
    public static class Program
    {
        ...
        {
            Console.Title = nameof(EndpointTwo);
            ...
            var host = Host
                ...
                {
                    var cfg = new EndpointConfiguration(nameof(EndpointTwo));
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    await messageSession.SendLocal(new SomeCommandTwo()).ConfigureAwait(false);
                }
            }
            finally
            {
