// <copyright file="MetricsDataFormattingTests.cs" company="App Metrics Contributors">
...
{
    public class MetricsDataFormattingTests : IClassFixture<MetricProviderTestFixture>
    {
