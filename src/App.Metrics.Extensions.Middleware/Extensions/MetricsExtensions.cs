...
// ReSharper restore CheckNamespace
{
    internal static class MetricsExtensions
    {
        ...
        {
            metrics.Mark(AspNetMetricsRegistry.Contexts.OAuth2.Meters.EndpointHttpRequests(routeTemplate),
        ...
        {
            metrics.Mark(AspNetMetricsRegistry.Contexts.OAuth2.Meters.HttpRequests,
                item => item.With("client_id", clientId).With("http_status_code", httpStatusCode.ToString()));
