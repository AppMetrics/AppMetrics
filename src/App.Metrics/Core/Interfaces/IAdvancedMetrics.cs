...
{
    /// <summary>
    ///     Gets more advanced application metrics operations
    /// </summary>
    ...
    {
        /// <summary>
        ///     Gets a the <see cref="IClock" /> configured used to measure by some <see cref="MetricType" />s that
        ...
        /// <summary>
        ///     Gets the <see cref="IMetricsDataProvider" /> configured to retrieve a snapshot of metrics being
        ///     recorded
        /// </summary>
        /// <value>
        ///     The data.
        ...
        /// <summary>
        ///     Gets the <see cref="IMetricsFilter" /> configured to globally filter metrics
        /// </summary>
        /// <value>
        ///     The global filter.
        /// </value>
        ...
        /// <summary>
        ///     Gets the <see cref="IHealthStatusProvider" /> configured to retrieve the current health status of the
        ...
        ///     <see cref="ICounter" />
        ///     or the existing registered instance of the counter
        /// </returns>
        ...
        /// </param>
        /// <param name="builder">
        ///     The function used to build a custom
        ///     <see cref="IHistogramMetric" />
        ///     metric.
        /// </param>
        ...
        /// <returns>A new instance of an <see cref="IApdex" /> or the existing registered instance of the apdex metric</returns>
        IApdex Track<T>(ApdexOptions options, Func<T> builder)
