...
#pragma warning disable 0659 // GetHashCode does not make sense for a histogram, even if Equals is implemented
    ...
    internal abstract class AbstractHistogram : AbstractHistogramBase, IEquatable<AbstractHistogram>
    {
        ...
        protected AbstractHistogram(long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits, int wordSizeInBytes,
            bool autoResize)
        ...
        protected AbstractHistogram(AbstractHistogram source)
            : this(
                source.getLowestDiscernibleValue(), source.getHighestTrackableValue(), source.getNumberOfSignificantValueDigits(),
                source.WordSizeInBytes, source.AutoResize)
        {
